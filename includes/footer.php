...
<footer id="sticky-footer fixed-bottom" class="flex-shrink-0 py-2 customize-bg-dark text-white-50" style=" box-shadow: 30px 30px 30px 30px rgba(2, 2, 2, 2); ">
